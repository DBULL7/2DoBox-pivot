...
checkImportanceNone(driver_fx);
checkImportanceNone(driver_chr);

// Show completed cards

function checkImportanceNone(driver) {
  ...
  driver.sleep(3000).then(function() {
    driver.findElement(By.id('importance-none')).click()
    driver.findElement(By.className('card-title')).getText().then(function(None) {
      if(None === 'please') {
